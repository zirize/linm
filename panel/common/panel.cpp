...
void Panel::Sort(void)
{
	...
	if (_bDirSort)
	{
		...
		{
			case SORT_NAME:
				sort(begin, end, sort_dir_adaptor<sort_name, sort_name>(_bDirSortAscend, _bFileSortAscend)); break;
			case SORT_EXT: 
				sort(begin, end, sort_dir_adaptor<sort_name, sort_ext>(_bDirSortAscend, _bFileSortAscend)); break;
			case SORT_SIZE: 
				sort(begin, end, sort_dir_adaptor<sort_name, sort_size>(_bDirSortAscend, _bFileSortAscend)); break;
			case SORT_TIME: 
				sort(begin, end, sort_dir_adaptor<sort_name, sort_time>(_bDirSortAscend, _bFileSortAscend)); break;
			case SORT_COLOR: 
				sort(begin, end, sort_dir_adaptor<sort_name, sort_color>(_bDirSortAscend, _bFileSortAscend)); break;
			case SORT_NONE:
			default:
				return;
		}
	...
	else
	{
		switch(_nSortMethod) 
		{
			case SORT_NAME: sort(begin, end, sort_ascend<sort_name>(_bFileSortAscend)); break;
			case SORT_EXT: sort(begin, end, sort_ascend<sort_ext>(_bFileSortAscend)); break;
			case SORT_SIZE: sort(begin, end, sort_ascend<sort_size>(_bFileSortAscend)); break;
			case SORT_TIME: sort(begin, end, sort_ascend<sort_time>(_bFileSortAscend)); break;
			case SORT_COLOR: sort(begin, end, sort_ascend<sort_color>(_bFileSortAscend)); break;
			case SORT_NONE:
			default:
				return;
		}
